...
# программы или нет. Обычно один тест проверят определённую функцию или класс 
# программы. Чтобы проверить всю функциональность программы, пишут множество
# тестов. Для удобства тесты группируют в специальные сущности (терминология 
# зависит от фреймворка):
#   test       --- проверяет одну функцию/класс на работу с одним определённым 
#                  входом,
#   test case  --- проверяет одну функцию/класс на набор различных входов,
#   test suite --- набор test case.
